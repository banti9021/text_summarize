...
from text_summarize import logger
...
@ensure_annotations
def create_directories(path_to_directories: List[Path], verbose: Optional[bool] = True):
    """Creates a list of directories.

    Args:
        path_to_directories (List[Path]): List of directory paths.
        verbose (Optional[bool]): If True, log directory creation (default: True).
    """
